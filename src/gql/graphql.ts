...
export type ChatSessionCreateNestedManyWithoutUserInput = {
	...
	connectOrCreate?: InputMaybe<
		Array<ChatSessionCreateOrConnectWithoutUserInput>
	>;
...
export type ChatSessionUpdateManyWithoutUserNestedInput = {
	...
	update?: InputMaybe<
		Array<ChatSessionUpdateWithWhereUniqueWithoutUserInput>
	>;
	updateMany?: InputMaybe<
		Array<ChatSessionUpdateManyWithWhereWithoutUserInput>
	>;
	upsert?: InputMaybe<
		Array<ChatSessionUpsertWithWhereUniqueWithoutUserInput>
	>;
};
...
export type MessageCreateNestedManyWithoutChatSessionInput = {
	...
	connectOrCreate?: InputMaybe<
		Array<MessageCreateOrConnectWithoutChatSessionInput>
	>;
...
export type MessageUpdateManyWithoutChatSessionNestedInput = {
	...
	update?: InputMaybe<
		Array<MessageUpdateWithWhereUniqueWithoutChatSessionInput>
	>;
	updateMany?: InputMaybe<
		Array<MessageUpdateManyWithWhereWithoutChatSessionInput>
	>;
	upsert?: InputMaybe<
		Array<MessageUpsertWithWhereUniqueWithoutChatSessionInput>
	>;
};
...
export type FindAllChatSessionsQuery = {
	__typename?: 'Query';
	findAllChatSessions: Array<{
		__typename?: 'ChatSession';
		id: string;
		title: string;
		userId: number;
...
export type FindAllMessagesQuery = {
	__typename?: 'Query';
	findAllMessages: Array<{
		__typename?: 'Message';
		id: string;
		type: string;
		sender: string;
...
export type GetAuthSessionQuery = {
	__typename?: 'Query';
	getAuthSession: {
		__typename?: 'SessionResponse';
	...
	definitions: [
		{
			...
			operation: 'mutation',
			name: { kind: 'Name', value: 'CreateChatSession' },
			variableDefinitions: [
				{
	...
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'FindAllChatSessions' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: {
					...
					type: {
						kind: 'NamedType',
						name: { kind: 'Name', value: 'ChatSessionWhereInput' },
					},
				},
			],
			selectionSet: {
			...
			variableDefinitions: [
				{
					...
					type: {
						...
						type: {
							kind: 'NamedType',
							name: { kind: 'Name', value: 'MessageCreateInput' },
						},
					},
				},
				{
					...
					type: {
						kind: 'NamedType',
						name: { kind: 'Name', value: 'SelectInput' },
					},
				},
			],
			selectionSet: {
...
>;
export const FindAllMessagesDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'FindAllMessages' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: {
					...
					type: {
						kind: 'NamedType',
						name: { kind: 'Name', value: 'MessageWhereInput' },
					},
				},
			],
			selectionSet: {
...
>;
export const GetAuthSessionDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'GetAuthSession' },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
					{
...
} as unknown as DocumentNode<GetAuthSessionQuery, GetAuthSessionQueryVariables>;
