...
import { GetAuthSessionDocument } from '@/features/auth/serverFns/getAuthSessionServerFn/GetAuthSessionDocument';

export const getAuthSessionServerFn = createServerFn({
	method: 'POST',
}).handler(async () => {
